...
if($exito){
    ...
    if(esValido($mensaje)){
        ...
        $cajaC->CAJA_APERTURA = $_GET['CAJA_APERTURA'];
        $datos = $cajaC->reportarCajasPorFecha($mensaje,$code_error,$exito);
