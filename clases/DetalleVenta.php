<?php
    ...
    class DetalleVenta{
        ...
        function listarDetallesPorVenta(&$mensaje, &$code_error,&$exito){
            ...
            $query ="SELECT PRO.PRO_ID, PRO.PRO_NOMBRE,PRO.PRO_TAMANIO_TALLA,CAT.CAT_NOMBRE,PRO.PRO_PRECIO_COMPRA,PRO.PRO_PRECIO_VENTA,DET.DET_CANTIDAD,DET.DET_IMPORTE FROM DETALLE_VENTA DET
